...
export class Address {
    ...
    */
    to_base58(network_prefix) {
        try {
            wasm.address_to_base58(8, this.ptr, network_prefix);
    ...
    */
    to_bytes(network_prefix) {
        wasm.address_to_bytes(8, this.ptr, network_prefix);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
...
export class Constant {
    ...
    */
    encode_to_base16() {
        try {
            wasm.constant_encode_to_base16(8, this.ptr);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class ContextExtension {
    ...
    */
    keys() {
        wasm.contextextension_keys(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
export class ErgoTree {
    ...
    */
    to_bytes() {
        wasm.ergotree_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
export class MinerAddress {
    ...
    */
    static mainnet_fee_address() {
        try {
            wasm.mineraddress_mainnet_fee_address(8);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    static testnet_fee_address() {
        try {
            wasm.mineraddress_testnet_fee_address(8);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class NetworkAddress {
    ...
    */
    to_base58() {
        try {
            wasm.networkaddress_to_base58(8, this.ptr);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    to_bytes() {
        wasm.networkaddress_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
export class ProverResult {
    ...
    */
    proof() {
        wasm.proverresult_proof(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
export class SecretKey {
    ...
    */
    to_bytes() {
        wasm.secretkey_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
